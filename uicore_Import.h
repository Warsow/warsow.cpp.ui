...
namespace UICore
{
	...
	public:
		...
		static void DrawImage( Image img, const Rect &src, const Rect &dest, const Color &color, const float angle = 0.0f );
		...
		static const int keyLShift;
		static const int keyLCtrl;
		static const int keyLAlt;
		static const int keyRShift;
		static const int keyRCtrl;
		static const int keyRAlt;
	};
}

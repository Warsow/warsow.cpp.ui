...
void SetupPlayerMenu::UpdatePlayerFields( void )
{
	...
	playerasalpha->setPressed( Trap::Cvar_Int( "cg_forceMyTeamAlpha" ) ? true : false );
	teamlessasbeta->setPressed( Trap::Cvar_Int( "cg_forceTeamPlayersTeamBeta" ) ? true : false );
}

...
namespace UICore
{
	...
	void Slider::setHorizontal( bool horizontal )
	{
		...
		{
			minus->setRotation( 0 );
			plus->setRotation( 180 );
			scrollbar->setRotation( 0 );
		}
		else
		{
			minus->setRotation( 270 );
			plus->setRotation( 90 );
	...
	{
		scrollbar->setHighlightColor( color );
	}
	...
	void Slider::setHighlightImage( Image image )
	{
		scrollbar->setHighlightImage( image );
	}
	...
	Color Slider::getHighlightColor( void ) const
	{
		return scrollbar->getHighlightColor();
	}
	...
	Image Slider::getHighlightImage( void ) const
	{
		return scrollbar->getHighlightImage();
	}

...
ServerInfo::ServerInfo( const char *adr, int pingbatch )
{
...
void ServerInfo::setServerInfo( const char *info )
{
	int		l;
	const char	*pntr;
	const char	*tok;
...
char *ServerInfo::GetResponseToken( const char **data_p )
{

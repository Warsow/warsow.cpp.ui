...
namespace UICore
{
	...
	protected:
		bool pressed;
		Color pressedColor;
		Color pressedHighlightColor;
		Color pressedFontColor;
		Image pressedImage;
		Image pressedHighlightImage;
	...
	void SwitchButton::setPressedHighlightColor( const Color &color )
	{
		pressedHighlightColor = color;
	}
	...
	void SwitchButton::setPressedHighlightImage( Image image )
	{
		pressedHighlightImage = image;
	}
	...
	Color SwitchButton::getPressedHighlightColor( void ) const
	{
		return pressedHighlightColor;
	}
	...
	Image SwitchButton::getPressedHighlightImage( void ) const
	{
		return pressedHighlightImage;
	}

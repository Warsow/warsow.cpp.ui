...
namespace UICore
{
	...
	public:
		...
		inline virtual void setHighlightFontColor( const Color &color );

		inline virtual Color getHighlightColor( void ) const;
		inline virtual Image getHighlightImage( void ) const;
		inline virtual Color getHighlightFontColor( void ) const;
	...
	void Button::setHighlightFontColor( const Color &color )
	{
	...
	Color Button::getHighlightFontColor( void ) const
	{

...
void SetupSoundMenu::UpdateSoundFields( void )
{
	...
	sound->setCurValue( (int)UICore::round(Trap::Cvar_Value( "s_volume" ) * 10.0f) );
	music->setCurValue( (int)UICore::round(Trap::Cvar_Value( "s_musicvolume" ) * 10.0f) );

	players->setCurValue( (int)UICore::round(Trap::Cvar_Value( "cg_volume_players" ) * 5.0f) );
	effects->setCurValue( (int)UICore::round(Trap::Cvar_Value( "cg_volume_effects" ) * 5.0f) );
	announcer->setCurValue( (int)UICore::round(Trap::Cvar_Value( "cg_volume_announcer" ) * 5.0f) );
	voicechats->setCurValue( (int)UICore::round(Trap::Cvar_Value( "cg_volume_voicechats" ) * 5.0f) );
	hit->setCurValue( (int)UICore::round(Trap::Cvar_Value( "cg_volume_hitsound" ) * 5.0f) );
}
